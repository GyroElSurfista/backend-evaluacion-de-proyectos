...
return [
    ...
    */
    ...
    | utilizando la convención "attribute.rule" para nombrar las líneas. Esto hace que
    ...
    */
    ...
    | posición de atributos con algo más fácil de leer, como la dirección de correo
    | electrónico en lugar de "email". Esto simplemente nos ayuda a hacer que nuestro
    | mensaje sea más expresivo.
    |
    */
