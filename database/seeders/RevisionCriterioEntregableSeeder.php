    ...
    public function run()
    {
        DB::table('RevisionCriterioEntregable')->insert([
            ...
            [
                ...
                'fecha' => '2024-10-01',
                'observacion' => 'Cumple con los requisitos',
                'identificadorCriteAceptEntre' => 17,
                'identificadorEvaluObjet' => 1,
            ],
            [
                'cumple' => false,
                'fecha' => '2024-10-01',
                'observacion' => 'No cumple con los requisitos',
                'identificadorCriteAceptEntre' => 18,
                'identificadorEvaluObjet' => 1,
            ],
            [
                'cumple' => true,
                'fecha' => '2024-10-01',
                'observacion' => 'Cumple parcialmente',
                'identificadorCriteAceptEntre' => 19,
                'identificadorEvaluObjet' => 1,
            ],
            [
                'cumple' => true,
                'fecha' => '2024-10-02',
                'observacion' => 'Cumple con observaciones menores',
                'identificadorCriteAceptEntre' => 20,
                'identificadorEvaluObjet' => 1,
            ],
            [
                'cumple' => false,
                'fecha' => '2024-10-02',
                'observacion' => 'No cumple con los estándares',
                'identificadorCriteAceptEntre' => 21,
                'identificadorEvaluObjet' => 1,
            ],
        ]);
    }
